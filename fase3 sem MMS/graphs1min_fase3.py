...
# Estética
plt.title("Intervalo por Irms 1 minuto fase B")
plt.ylabel("Intervalo por Irms")
plt.legend(loc='upper right')
plt.tight_layout()
...
# Estética
plt.title("Intervalo por Irms 1 minuto fase C")
plt.ylabel("Intervalo por Irms")
plt.legend(loc='upper right')
plt.tight_layout()
plt.show()
...
# Estética
plt.title("Irms 1 minuto fase B")
plt.ylabel("Irms")
plt.legend(loc='upper right')
plt.tight_layout()
...
# Estética
plt.title("Irms 1 minuto fase C")
plt.ylabel("Irms")
plt.legend(loc='upper right')
plt.tight_layout()
plt.show()
...
# Estética
plt.title("Irms 2 casas decimais 1 minutos fase B")
plt.ylabel("Irms")
plt.legend(loc='upper right')
plt.tight_layout()
#plt.show()
...
# Estética
plt.title("Irms 2 casas decimais 1 minuto fase C")
plt.ylabel("Irms")
plt.legend(loc='upper right')
plt.tight_layout()
plt.show()
